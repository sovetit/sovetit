## Привет!
### Я Full Stack разработчик, мой главный стек технологий включает в себя PHP, MySQL, PostgreSQL, TypeScript, Java, Docker и Git, а также фреймворки, такие как Laravel и Symfony. Мои проекты всегда основаны на качественном коде, который обеспечивает масштабируемость и поддерживаемость.
